  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fdf5e6] p-4 transition-colors duration-700">
      ...
      <footer className="mt-12 pb-4 text-[#8b4513] text-[12px] text-center tracking-widest">
        ...
        <p className='normal-case pt-2 md:pt-0 opacity-35'>This organization follows <a href="https://hr.cornell.edu/about/workplace-rights/equal-education-and-employment"><u>Cornell's Equal Education and Employment Guidelines</u></a></p>
      </footer>
